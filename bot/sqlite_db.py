...
def sqlite_adjust_task_assignments(task_id: str, date_str: str) -> list[dict]:
    ...
    cursor.execute("""
        ...
        WHERE task_id = ? AND date = ? AND status = 'PENDING' AND verified_by IS NOT NULL AND verified_by != ''
    """, (task_id, date_str))
